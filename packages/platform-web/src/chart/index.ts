/**
 * The chart organism's public surface: one component namespace and its types.
 *
 ...
 * flooding `core-ui`'s flat barrel and makes the family obvious at the call site.
 * Everything under `shared/` is internal — a feature reaching for `ChartShell` or
...
export type { StatTileProps, StatTileSkeletonProps } from "./stat";
export type {
	SunburstChartProps,
